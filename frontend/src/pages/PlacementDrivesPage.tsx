 ...
 *
 * Admin interface for managing campus placement drives.
 * Features: CRUD operations, filters, drive details, student tracking.
 */
...
const mockDrives: PlacementDrive[] = [
    ...
    },
    {
        ...
        lastDateToApply: '2026-03-10',
        location: 'Online',
        eligibleBranches: ['CS'],
        minCGPA: 8.0,
        status: 'Upcoming',
        rounds: ['Online Coding', 'Phone Screen', 'On-site Interview'],
        registeredStudents: 23,
        selectedStudents: 0,
        description: 'Google Summer Internship for SDE role. Strong DSA and competitive programming background preferred.',
    },
    {
        id: '5',
        ...
        packageLPA: '4.0',
        driveDate: '2026-01-28',
        lastDateToApply: '2026-01-25',
        location: 'Campus - Main Auditorium',
        eligibleBranches: ['CS', 'IT', 'EC', 'EE', 'ME'],
        minCGPA: 5.5,
        status: 'Completed',
        rounds: ['Cognitive Assessment', 'Coding Test', 'Communication Assessment'],
        registeredStudents: 150,
        selectedStudents: 48,
        description: 'Accenture mass recruitment. Minimum requirements kept low to maximize participation.',
    },
    {
        id: '6',
        companyName: 'Amazon',
        ...
        selectedStudents: 5,
        description: 'Amazon SDE-1 hiring. Strong problem-solving and system design skills required.',
    },
];
...
const PlacementDrivesPage = () => {
    ...
    const handleAddDrive = () => {
        const newDrive: PlacementDrive = {
            ...
            selectedStudents: 0,
            description: 'New placement drive. Edit details to update.',
        };
