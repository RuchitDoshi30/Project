 ...
 *
 * Admin interface for creating and managing notices/announcements.
 * Features: CRUD, priority levels, target audience, pinning, expiry.
 */
...
const mockAnnouncements: Announcement[] = [
    ...
    {
        id: '4',
        title: 'Mock Interview Sessions — Register Now',
        body: 'Mock interview sessions will be held from March 1-5 for all placed and unplaced students. Schedule: 10:00 AM - 4:00 PM daily. Panels: Technical + HR. Register by Feb 27 through the placement portal. Limited slots available — first come, first served.',
        priority: 'Normal',
        targetAudience: 'All Branches — Final Year',
        createdAt: '2026-02-13T11:00:00Z',
        expiresAt: '2026-02-27T23:59:00Z',
        isPinned: false,
        author: 'Dr. Placement Coordinator',
        views: 145,
    },
    {
        id: '5',
        title: 'Aptitude Test Series — Mandatory Participation',
        body: 'Mandatory aptitude test series starts from February 18. Tests will be conducted every Tuesday and Thursday from 4:00 PM - 5:00 PM. Topics: Quantitative, Logical, Verbal. Students scoring below 50% will be assigned additional practice assignments. No exemptions.',
        priority: 'Important',
        targetAudience: 'CS, IT, EC — Pre-Final Year',
    ...
    {
        id: '6',
        title: 'Wipro Drive Results — Congratulations!',
        body: 'We are pleased to announce that 32 students have been selected in the Wipro campus drive held on January 15, 2026. Selected students will receive their offer letters via email within 2 weeks. Congratulations to all selected candidates! The list is available on the notice board.',
        priority: 'Normal',
        targetAudience: 'All Students',
...
const AnnouncementsPage = () => {
    ...
    const handleAddAnnouncement = () => {
        const newAnnouncement: Announcement = {
            ...
            body: 'Edit this announcement to add details.',
            priority: 'Normal',
            targetAudience: 'All Students',
                        ...
                        >
                            <div className="p-5">
                                ...
                                <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-lc-border">
                                    ...
                                    <button className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all">
