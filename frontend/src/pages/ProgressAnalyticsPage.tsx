    ...
    <Container>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <Card className="hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between p-4">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mb-1">{overview.totalProblemsSolved}</p>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between p-4">
            <div className="flex-1">
              <p className="text-xs text-gray-500 mb-1">Aptitude Tests</p>
              <p className="text-2xl font-bold text-gray-900 mb-1">{aptitudeStats.totalTestsPassed}</p>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between p-4">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mb-1">{overview.averageScore}%</p>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <div className="flex items-start justify-between p-4">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mb-1">{overview.currentStreak}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        <Card className="p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-gray-900">Weekly Goal</h3>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-2xl font-bold text-gray-900">{goals.weeklyProgress}</span>
              <span className="text-sm text-gray-600">/ {goals.weeklyTarget} problems</span>
            </div>
        ...
        <Card className="p-5 border-l-4 border-green-600">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-gray-900">Monthly Goal</h3>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-2xl font-bold text-gray-900">{goals.monthlyProgress}</span>
              <span className="text-sm text-gray-600">/ {goals.monthlyTarget} problems</span>
            </div>
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-gray-900 rounded-full transition-all duration-500"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <Card className="p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-gray-900">Difficulty Progress</h3>
          </div>
              ...
              <div key={category.name} className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-semibold text-gray-900">{category.percentage}%</span>
                  </div>
      ...
      <Card className="p-5 mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-gray-900">Aptitude Performance</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          {Object.entries(aptitudeStats.byCategory).map(([category, stats]) => (
            <div key={category} className={`rounded-lg p-4 border hover:shadow-sm transition-all ${
              category === 'Quantitative' ? 'bg-blue-50 border-blue-200' :
              category === 'Logical' ? 'bg-purple-50 border-purple-200' :
              category === 'Verbal' ? 'bg-green-50 border-green-200' :
              'bg-orange-50 border-orange-200'
            }`}>
              <h4 className="text-xs font-semibold text-gray-700 mb-2">{category}</h4>
              <p className="text-2xl font-bold text-gray-900 mb-1">{stats.bestScore}%</p>
              <p className="text-xs text-gray-600">Best Score</p>
              <p className="text-xs text-gray-500 mt-1">{stats.attempts} attempts · Avg: {stats.avgScore}%</p>
            </div>
          ))}
        </div>
        <div className="flex items-center justify-center gap-8 pt-4 border-t border-purple-200">
          <div className="text-center">
            <p className="text-2xl font-bold text-green-600 mb-1">{aptitudeStats.totalTestsPassed}</p>
            <p className="text-xs text-gray-600 font-semibold">✅ Passed</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-bold text-red-600 mb-1">{aptitudeStats.totalTestsFailed}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        <Card className="p-5 border-l-4 border-green-600">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-gray-900">Your Strengths</h3>
          </div>
        ...
        <Card className="p-5 border-l-4 border-orange-600">
          ...
          <div className="space-y-2">
            {weaknesses.map((weakness, index) => (
              ...
              >
                <span className="text-sm font-medium text-gray-800">{weakness}</span>
              </div>
            ))}
          </div>
        </Card>
      ...
      <Card className="p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-gray-900">Time Analysis</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center bg-blue-50 rounded-lg p-4 border border-blue-200">
            <p className="text-3xl font-bold text-blue-600 mb-1">{formatTime(overview.totalTimeSpent)}</p>
            <p className="text-xs font-medium text-gray-600">Total Time Spent</p>
          </div>
          <div className="text-center bg-purple-50 rounded-lg p-4 border border-purple-200">
            <p className="text-3xl font-bold text-purple-600 mb-1">{Math.round(overview.totalTimeSpent / overview.totalProblemsSolved)}</p>
            <p className="text-xs font-medium text-gray-600">Avg Minutes/Problem</p>
          </div>
          <div className="text-center bg-green-50 rounded-lg p-4 border border-green-200">
            <p className="text-3xl font-bold text-green-600 mb-1">{overview.longestStreak}</p>
